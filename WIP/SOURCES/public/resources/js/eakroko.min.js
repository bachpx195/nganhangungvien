...
$(document).ready(function () {
	...
	if ($('.plupload').length > 0) {
		$(".plupload").each(function () {
			...
			$el.pluploadQueue({
				...
				url                : 'http://www.eakroko.de/flat/js/js/plupload/upload.php',
				max_file_size      : '10mb',
				chunk_size         : '1mb',
				unique_names       : true,
				resize             : {
				...
				silverlight_xap_url: 'http://www.eakroko.de/flat/js/js/plupload/Moxie.xap'
			});
	...
	if ($('.file-manager').length > 0) {
		$('.file-manager').elfinder({
			url: 'http://www.eakroko.de/flat/js/js/plugins/elfinder/php/connector.php'
		});
	}
	...
	$(".language-select a.language-toggle").click(function(e) {
		e.preventDefault();
		$.ajax({
			url: '/lang/' + $(this).attr('data-language'),
			type: 'get',
