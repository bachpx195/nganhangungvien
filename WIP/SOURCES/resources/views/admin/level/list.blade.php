            ...
            <div class="portlet light ">
                ...
                <div class="portlet-body">
                    <div class="table-toolbar">
                        <div class="row">
                                <div class="col-md-5">
                                    <form id="user" class="form-horizontal" role="form" method="get" action="{{ route('admin.level.list') }}">
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="Trình độ...." name="name" value="{{ $name }}" >
                                ...
                                <div class="col-md-7">
                                    <div class="btn-group pull-right">
                                        <button id="sample_editable_1_new" class="btn sbold green" onclick="location.href='{{ route('admin.level.form') }}'">Thêm mới
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column">
                        <thead>
                            <tr>
                                <th>STT</th>
                                <th class="text-center" >Trình độ học vấn</th>
