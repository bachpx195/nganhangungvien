                            ...
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <button class="btn sbold green">
                                        <a href="{{route('admin.companysize.form')}}" target="_blank" class="add-more-btn">
                                            THÊM QUY MÔ CÔNG TY <i class="fa fa-plus"></i>
                                        </a>
                                    </button>
                                </div>
                            </div>
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 80%;" class="text-center">Quy mô công ty</th>
