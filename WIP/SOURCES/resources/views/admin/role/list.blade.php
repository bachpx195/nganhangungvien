                    ...
                    <div class="actions">
                        <div class="btn-group">
                            <button class="btn sbold green">
                                <a href="{{route('admin.role.update')}}" class="add-more-btn">
                ...
                <div class="portlet-body">
                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                        ...
                        <tr>
                            ...
                            <th style="width: 85%;" class="text-center">Tên quyền</th>
                        ...
                        @if(count($roles) > 0)
                            @foreach($roles as $index=>$item)
                                <tr class="gradeX odd" role="row">
                                    ...
                                    <td>
                                        <a href="{{route('admin.role.update'). '?id=' . $item->id}}" target="_blank">
