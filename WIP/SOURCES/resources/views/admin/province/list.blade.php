                    ...
                    <div class="actions">
                        <div class="btn-group">
                            <button class="btn sbold green">
                                <a href="{{route('admin.province.form')}}" target="_blank" class="add-more-btn">
                                    THÊM TỈNH/THÀNH PHỐ <i class="fa fa-plus"></i>
                                </a>
                            </button>
                        </div>
                    </div>
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 85%;" class="text-center">Tỉnh/Thành phố</th>
