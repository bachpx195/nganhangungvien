            ...
            <div>
                <div class="row pl_14 pr_14">
                    <div class="txc">
                        ...
                        <span class="bg-white bold font16 text_blue"><i class="fa fa-skype" aria-hidden="true"></i> Skype  : </span><span class="bg-white text_pink font16 bold"><a href="skype:CSKH.NGANHANGUNGVIEN.COM?chat" class="text_pink">nganhangungvien.com</a></span>
                    </div>
                    <br/>
                </div>
            </div>
