	...
	@endif
		...
		<div>
			<div class="row">
				...
				<div>
					<span class="bg-white bold font14 text_blue"><i class="fa fa-phone" aria-hidden="true"></i> Hotline: </span><span class="bg-white text_pink font14 bold">04 6684 7421</span><br>
					...
					<span class="bg-white bold font14 text_blue"><i class="fa fa-skype" aria-hidden="true"></i> Skype: </span><span class="bg-white text_pink font14 bold"><a href="skype:NGANHANGUNGVIENVN@GMAIL.COM?chat" class="text_pink">nganhangungvienvn@gmail.com</a></span>
				</div>
			</div>
		</div>
		<br/>
