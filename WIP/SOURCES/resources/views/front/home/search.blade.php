		...
		<div>
			<div class="row">
				...
				<div>
					...
					<span class="bg-white bold font14 text_blue"><i class="fa fa-skype" aria-hidden="true"></i> Skype: </span><span class="bg-white text_pink font14 bold"><a href="skype:NGANHANGUNGVIENVN?chat" class="text_pink">nganhangungvien.com</a></span>
				</div>
			</div>
		</div>
		<br/>
