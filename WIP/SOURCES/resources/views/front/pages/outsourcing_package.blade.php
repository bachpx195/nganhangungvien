						...
						<div class="center-p12p24">
							...
							<div class="row pl_14 pr_14">
								<div class="txc">
									...
									<span class="bg-white bold font24 text_blue"><i class="fa fa-skype" aria-hidden="true"></i> Skype  : </span><span class="bg-white text_pink font24 bold"><a href="skype:live:NGANHANGUNGVIENVN?chat" class="text_pink">nganhangungvienvn</a></span>
								</div>
								<br/>
							</div>
						</div>
