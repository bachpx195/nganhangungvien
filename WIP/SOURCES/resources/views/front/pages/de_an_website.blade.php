			...
			<div class="block_ntv_dangky regis_header h_56" id="regis_header">
				...
				<div class="w_50 floatLeft">
					<span class="title_ntd_dky "></span><span
							class="uppercase bold fs16 color_ntd_dky">ĐỀ ÁN CUNG CẤP DỊCH VỤ THƢƠNG MẠI ĐIỆN TỬ NGANHANGUNGVIEN.VN</span>
				</div>
			</div>
					...
					<div class="mb8">
						<div class="center-p12p24">
							<div style="width: 90%; margin-top: 30px; margin-left: 5%; padding-bottom: 30px;">
								<iframe width="99%" height="800px" src='{{Constants::GOOGLE_DOC_PATH}}?url={{URL::to('/') . '/assets/pages/files/de-an-website-tmdt.pdf'}}&embedded=true' frameborder='0'></iframe>
	                        </div>
						</div>
					</div>
				</div>
