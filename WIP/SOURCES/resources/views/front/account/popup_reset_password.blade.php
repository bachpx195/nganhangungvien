                                ...
                                <form class="form-horizontal" id="resetPassword" name="resetPassword" action=""
                                   ...
                                   <div id="block-thong-tin-dang-nhap" class="mb_12 pt_4">
                                      ...
                                      <div class="form-group clearfix mb_8">
                                         <label for="inputEmail" class="control-label-info bold txt-ghi fs14 w160">
                                      ...
                                      <div class="form-group mb_4">
                                         <label class="control-label-info w160"></label>
                                         <div class="fr-input-wd374 floatLeft" id="sent">
                                            <button type="button" id="btnSend" class="btn btnRegister w151 fwb uppercase sent" >Gửi</button>
                                            <button type="button" id="btnSend" class="btn btnRegister w151 fwb uppercase senting display_none">Đang gửi...</button>
                                         </div>
                                      </div>
                                      <div class="mb_2 pl_155 fs14 txt-color-363636">Bạn chưa có tài khoản? <a href="{{route('employer.register')}}" class="member_register txt-xanh-la-cay underline">Đăng ký?</a></div>
                                   </div>
                                </form>
                             </div>
                          </div>
