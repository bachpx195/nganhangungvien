        ...
        <div id="div-frm-kinhnghiem" class="mt_8">
            <div class="box-edit form display_block">
                <form id="frmkinhnghiem" name="frmThamkhaoNew">
                    <input type="hidden" name="kinhnghiem_created"
                           id="kinhnghiem_created" value="0">
                    <input type="hidden" name="kinhnghiem_form_show"
                           id="kinhnghiem_form_show" value="1">
                    <div class="">
                        ...
                        <div class="form-group mt16">
                            ...
                            <div class="fr_ip_vtmm col-xs-8">
                                <input name="kinhnghiem[c_cong_ty]" type="text"
                        ...
                        <div class="form-group mt16">
                            ...
                            <div class="fr_ip_vtmm col-xs-8">
                                <input name="kinhnghiem[c_chuc_danh]" type="text"
                                       class="inputTextKNEdit form-control input-lg2 color-input required"
                                       id="address" value=""/>
                            </div>
                        ...
                        <div class="form-group mt_16">
                            ...
                            <div class="fr_ip_vtmm pl_18 select_style31 city_select">
                                ...
                                <div id="c_thoigian"
                                     class="w87 filter_box font14 style-flat  reg_box_tinhthanh box_tinhthanh_reg  floatLeft mr_8 ml_6">
                                    <select id="start_month"
                                            name="kinhnghiem[c_thoi_gian_bat_dau_thang]"
                                            class="checkComboboxKNEdit selectpicker checkCombobox box_select_filter_reg pos_relative w65 select_time required"
                                            data-disS="1">
                                ...
                                <div class="w87 filter_box font14 style-flat reg_box_tinhthanh box_tinhthanh_reg floatLeft mr_8">
                                    <select id="start_year"
                                            name="kinhnghiem[c_thoi_gian_bat_dau_nam]"
                                            class="checkComboboxKNEdit selectpicker checkCombobox box_select_filter_reg pos_relative w65 select_time  required"
                                            data-disS="1">
                                ...
                                <div class="kn_denthang w87 filter_box font14 style-flat reg_box_tinhthanh box_tinhthanh_reg floatLeft mr_8">
                                    <select id="end_month"
                                            name="kinhnghiem[c_thoi_gian_ket_thuc_thang]"
                                            class="checkComboboxKNEdit selectpicker checkCombobox box_select_filter_reg pos_relative w65 select_time required"
                                            data-disS="1">
                                        <option value="0" selected>Tháng</option>
                                        <option value="1">1</option>
                                ...
                                <div class="kn_dennam ml_4 w87 filter_box font14 style-flat reg_box_tinhthanh box_tinhthanh_reg floatLeft">
                                    <select id="end_year"
                                            name="kinhnghiem[c_thoi_gian_ket_thuc_nam]"
                                            class="checkComboboxKNEdit selectpicker checkCombobox box_select_filter_reg pos_relative w65 select_time  required"
                                            data-disS="1">
                                        <option value="0" selected>Năm</option>
                                        <option value="2016">2016</option>
                            ...
                            <div class="box-cvht">
                                <div class="demo-list">
                                    <input tabindex="1" type="checkbox"
                                           name="kinhnghiem[c_cong_viec_hien_tai]"
                                           id="chk_c_cong_viec_hien_tai" value="1">
                                    <label for="cvht" class="font14 fwn">Công việc
                                        hiện tại</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group clearfix mb_12">
                            ...
                            <div class="pl_8 w120 floatLeft select_style31 city_select">
                                <div class="w112 filter_box font14 style-flat reg_box_tinhthanh box_tinhthanh_reg floatLeft">
                                    <select id="m_type"
                                            name="kinhnghiem[c_loai_tien_te]"
                                            class="selectpicker checkCombobox box_select_filter_reg pos_relative w94 select_time"
                                            data-disS="1">
                            ...
                            <div class="fr-input-wd200">
                                <input type="text"
                                       class="inputTextKNEdit1 form-control input-lg2 color-input"
                                       id="salary" name="kinhnghiem[c_muc_luong]"
                                       placeholder="Nhập số"/>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                        ...
                        <div class="form-group clearfix mt_16">
                            ...
                            <div class="fr_ip_vtmm col-xs-8">
                                                                    <textarea name="kinhnghiem[c_mo_ta_cong_viec]"
                                                                              class="form-control pt4 pb4 pl_10 pr_10 inputTextAreaKNEdit required"
                                                                              id="mo_ta_cong_viec" rows="5"></textarea>
                            </div>
                        ...
                        <div class="form-group clearfix mt_16">
                            ...
                            <div class="fr_ip_vtmm col-xs-8">
                                                                    <textarea name="kinhnghiem[c_thanh_tich_dat_duoc]"
                                                                              class="form-control pt4 pb4 pl_10 pr_10 "
                                                                              id="thanh_tich" rows="5"></textarea>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                        ...
                        <div class="form-group mb1 input-phone">
                            ...
                            <div class="fr-input-wd153">
                                <div class="fr-input-wd153 floatLeft">
                                    <button type="button" id="btnSaveKN"
                                            class="ml_15 mr_10 btn btnluu w153 fwb uppercase fs16">
                                        Lưu
                                    </button>
                                </div>
                                <div class="fr-input-wd153 floatLeft">
                                    <button type="reset" id="btnRegisterKN"
                                            class="btn btnhuy w153 fwb uppercase fs16 display_none">
                                        Hủy
                                    </button>
                                </div>
                            </div>
